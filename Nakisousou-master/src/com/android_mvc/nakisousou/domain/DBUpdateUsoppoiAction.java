 ...
 *
 */
public class DBUpdateUsoppoiAction extends BaseAction
{
    ...
    public DBUpdateUsoppoiAction(DBListActivity activity, Long friend_id) {
    ...
    {
        // DB更新を実行
        Nakisou f = new NakisouDAO(activity).usoppoi(friend_id);
    ...
    static class DBUpdateActionResult extends ActionResult
    {
        ...
        {
            UIUtil.longToast(activity, friend.getName() + "さんはあんまり泣いてなさげになりました。");
        }
    }
